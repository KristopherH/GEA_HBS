...
struct Vec2
{
	...
	Vectormath::Aos::Vector2 operator=(Vec2& _vec) { return Vectormath::Aos::Vector2(_vec.x, _vec.y); };
	Vec2 operator=(Vectormath::Aos::Vector2& _vec) { return Vec2(_vec.getX(), _vec.getY()); };
