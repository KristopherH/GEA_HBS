...
#pragma region UI
 ...
 Button* save = new Button(new Sprite("Button", GameData::renderer), "SaveButon", "Button", "", Vec2(0.0f, 0.0f));
	...
	Button* load = new Button(new Sprite("Button", GameData::renderer), "SaveButon", "Button", "Save", Vec2(0.0f,0.0f));
