...
{		
	...
	Scoretxt->setColor(Vec4(0.0f, 0.0f, 0.40f, 1.0f));

	Button* menuBtn = new Button(new Sprite("Button3", GameData::renderer), "button1", "Button", "Main Menu");
