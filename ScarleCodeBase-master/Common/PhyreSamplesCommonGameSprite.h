...
namespace Phyre
{
	namespace PSamplesCommon
	{
		...
		public:
			...
			static float s_xScale;										// The optional scaling factor of the game world in the X direction.
			static float s_yScale;									    // The optional scaling factor of the game world in the Y direction.
