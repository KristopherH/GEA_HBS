...
#include "PhyreSamplesCommon.h"
#include "PhyreSamplesCommonDebug.h"
#include "PhyreSamplesCommonScene.h"
#include "PhyreSamplesCommonTexture.h"
#include "PhyreSamplesCommonScripting.h"
#include "PhyreSamplesCommonRasterComponent.h"
#include "PhyreSamplesCommonRasterComponent.inl"
#include "PhyreSamplesCommonRasterComponentAssets.h"
	...
	namespace PSamplesCommon
	{
		...
		PResult	RasterComponent::Initialize()
		{
			...
			if (!s_init)
			{
				...
				{
					// Load the asset
					PResult result = PCluster::LoadAssetFile(s_rasterLoadedClusters[i], g_rasterFileNames[i]);
					if (result != PE_RESULT_NO_ERROR)
					{
						PHYRE_ERROR("Unable to load required Phyre file: '%s' - Please rebuild the Scripting sample assets\n", g_rasterFileNames[i]);
						return result;
					}
