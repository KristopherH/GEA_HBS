...
namespace Phyre
{
	namespace PSamplesCommon
	{
		...
		PResult	RasterComponent::setRasterDotColor(const Vectormath::Aos::Vector3 &dotColor)
		{
			m_dotColor = dotColor;
			PHYRE_TRY(PSamplesCommon::UpdateVec3ParamOnMeshInstance(m_rasterMeshInstance, PD_RASTER_MESH_SEGMENT, "RasterDotColour", dotColor));
		...
		PResult RasterComponent::setRasterDotTexture(PRendering::PTexture2D *rasterDotTexture)
		{
			...
			PHYRE_TRY(PSamplesCommon::UpdateTextureParamOnMeshInstance(m_rasterMeshInstance, PD_RASTER_MESH_SEGMENT, "RasterDotSampler", *m_rasterDotTexture, s_bilinearSampler));
			return PE_RESULT_NO_ERROR;
		}
		...
		PResult RasterComponent::setDecay(float decay)
		{
			...
			m_decay = decay;
			PHYRE_TRY(PSamplesCommon::UpdateFloatParamOnMeshInstance(m_rasterMeshInstance, PD_RASTER_MESH_SEGMENT, "RasterDecay", m_decay));
