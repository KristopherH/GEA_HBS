...
#include <Gameplay/PhyreAttachableComponent.h>
#include <Gameplay/PhyreScriptedComponent.h>
#include <Gameplay/PhyreCameraControllerComponent.h>
...
namespace Phyre
{
	namespace PSamplesCommon
	{
		...
		{
			PScene::PUtilityScene::UpdateWorldMatricesForNodes(cluster);
		}
		...
		{
			PScene::PUtilityScene::UpdateWorldMatricesForNodes(world);
		}
